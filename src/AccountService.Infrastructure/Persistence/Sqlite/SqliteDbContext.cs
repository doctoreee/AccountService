...
using AccountService.Domain.RepositoryInterfaces;
using Microsoft.EntityFrameworkCore;
using System.Linq.Expressions;

namespace AccountService.Infrastructure.Persistence.Sqlite;

public class SqliteDbContext <T, TKey> : IRepository<T, TKey> where T : Entity<TKey>, new ()
{
    private readonly DbContext _context;
    private readonly DbSet<T> _entities;

    public SqliteDbContext(DbContext context)
    {
        _context = context;
    ...
    public Task<T> UpdateAsync(Expression<Func<T, bool>> predicate, T entity)
    {
